...
<html lang="en">
    <head>
        <title>BCBC Election Service</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="main">
            <form method="POST">
                <input type="text" name="name" placeholder="BC Login Username (part of email before '@' symbol)"><br>
                <input type="password" name="psswd" placeholder="BC Login Password"><br>
