    ...
    <body>
        ...
        <div class="main">
            <h2 style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;
                        font-weight: 400; font-size: 40px;">Nominations</h2>
            ...
            font-weight: 400; font-size: 20px;">*Nomination/position title here*</h4>
            <form method="POST" action="/Users/michaelm/Documents/BCBC Webpage/postVNPage.html">
                <input type="text" name="name" placeholder="Name of nominee"><br>
                <input type="text" name="dept" placeholder="Department of nominee"><br>
                <input type="text" name="reason" placeholder="Reason this nominee would be a good fit"><br>
